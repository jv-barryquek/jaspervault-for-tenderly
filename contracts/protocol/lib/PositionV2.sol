...
library PositionV2 {
     ...
     */
    function hasDefaultPosition(IJasperVault _jasperVault, address _component) public view returns(bool) {
     ...
     */
    function hasExternalPosition(IJasperVault _jasperVault, address _component) public view returns(bool) {
     ...
     */
    function hasSufficientDefaultUnits(IJasperVault _jasperVault, address _component, uint256 _unit) external view returns(bool) {
        return _jasperVault.getDefaultPositionRealUnit(_component) >= _unit.toInt256();
    }

    /**
     * Returns whether the JasperVault component's external position is greater than or equal to the real units passed in.
     */
     ...
     */
    function editDefaultPosition(IJasperVault _jasperVault, address _component, uint256 _newUnit) public {
    ...
    function editCoinType(IJasperVault _jasperVault, address _component,uint256 coinType) public {
     ...
     */
    function getDefaultTrackedBalance(IJasperVault _jasperVault, address _component) external view returns(uint256) {

...
contract PerpV2LibraryV2Mock {
    ...
    function testInvokeDeposit(
        ...
        external
    {
        return PerpV2LibraryV2.invokeDeposit(_jasperVault, _vault, _asset, _amountNotional);
    }
    ...
    function testInvokeWithdraw(
        ...
        external
    {
        return PerpV2LibraryV2.invokeWithdraw(_jasperVault, _vault, _asset, _amountNotional);
    }
    ...
    {
        return PerpV2LibraryV2.invokeOpenPosition(_jasperVault, _clearingHouse, _params);
    }
    ...
    {
        return PerpV2LibraryV2.invokeSwap(_jasperVault, _quoter, _params);
    }

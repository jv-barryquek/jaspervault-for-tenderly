...
interface IJasperVault is IERC20 {
     ...
     * @param coinType            Number representing whether or not to associate the component with a particular protocol.
     *  0 == RegularAsset, 1 == Aave (either aToken or dToken), 2 == Compound (cToken), 3 == Spark (spToken or dToken)
     */
    struct Position {
        address component;
        address module;
     ...
     * @param coinType            Number representing whether or not to associate the component with a particular protocol.
     *  0 == RegularAsset, 1 == Aave (either aToken or dToken), 2 == Compound (cToken), 3 == Spark (spToken or dToken), 4 == Maker/Spark (sToken)
